...
from ..backbone_3d import PillarsEncoderHard
from ..backbone_2d import DenseRPNHead
...
class PointPillars(AnchorBasedSingleStageDetector):
    def __init__(self,
                 classes: List[str],
        ...
        self.encoder = PillarsEncoderHard(
